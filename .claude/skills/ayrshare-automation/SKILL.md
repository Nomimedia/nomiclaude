...
description: "Publish and schedule social posts across Instagram, TikTok, YouTube, Facebook, LinkedIn, X/Twitter, and Pinterest via Ayrshare (Rube MCP / Composio). Use for cross-posting, scheduling content, and pulling post analytics. Always search tools first for current schemas."
requires:
  mcp: [rube]
---
