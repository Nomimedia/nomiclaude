...
description: "Manage Meta (Facebook & Instagram) ad campaigns, ad sets, creatives, and performance reporting via Rube MCP (Composio). Use for creating/editing ads and pulling ad metrics. Always search tools first for current schemas."
requires:
  mcp: [rube]
---
