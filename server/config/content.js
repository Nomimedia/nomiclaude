/* =============================================================================
   CURATED CONTENT — the parts of the OS that don't come from a live API.
   (company profile, packages, skills, agents, portfolio, integration list,
    and the fallback clients/meetings used when the live APIs return nothing)

   Edit this file to change curated content, then restart the server.
   The browser also carries an identical copy in os/data/nomi-data.js so the
   dashboard still works if it's opened without the backend.
   ============================================================================= */
"use strict";
